...
//
func (r *Repository) create(items models.Ratings) (err error) {
	_, err = r.db.NewInsert().On("conflict (user_id, criteria_id, speech_id) do update").
		Model(&items).
